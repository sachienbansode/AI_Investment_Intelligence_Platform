...
DEFAULTS: dict = {
    ...
    "tos_html": (
        ...
        "<p><b>Important:</b> All AI outputs in this application — scores, insights, summaries and chat responses "
        "— are generated by artificial intelligence for informational purposes only. They are not investment "
        "advice, research reports, or recommendations to buy or sell securities, and must be reviewed and approved "
        "before business or regulatory use. Investments in securities markets are subject to market risks. Please "
        "consult a SEBI-registered investment adviser before investing.</p>"
        "<h3>1. Nature of the service</h3><p>The Platform provides information and analytics about listed securities "
        "in Indian markets. It is not an investment adviser, research analyst, portfolio manager, broker or "
        "distributor, and nothing here constitutes investment, legal, tax or financial advice.</p>"
        "<h3>2. Eligibility &amp; account</h3><p>You must be at least 18 and legally able to contract. Access is "
        "invite-only; invite codes are personal and may not be shared. You are responsible for your credentials and "
        "for all activity under your account.</p>"
        "<h3>3. Acceptable use</h3><p>Do not rely on any output as a recommendation to transact, scrape or resell "
        "data except via an authorised Partner API, or present outputs as independent advice or research.</p>"
        "<h3>4. Data &amp; AI limitations</h3><p>Market data may be delayed or inaccurate; prices are indicative, "
        "not for execution. AI outputs may be incomplete or incorrect and the methodology may change without notice; "
        "verify independently before use.</p>"
        "<h3>5. Liability</h3><p>You are solely responsible for your investment decisions. To the maximum extent "
        "permitted by law, NIYTRI Technologies is not liable for any loss arising from use of, or reliance on, the "
        "Platform or its outputs.</p>"
        "<h3>6. Changes &amp; governing law</h3><p>We may update these Terms and require re-acceptance. These Terms "
        "are governed by the laws of India.</p>"
    ),
